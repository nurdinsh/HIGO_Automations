...
WebUI.scrollToElement(findTestObject('HIGO_Blogs/bt_Hangout'), 0)

WebUI.click(findTestObject('HIGO_Blogs/bt_Hangout'))

WebUI.verifyElementVisible(findTestObject('HIGO_Blogs/div_Hangout'))
