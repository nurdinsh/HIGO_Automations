...
WebUI.scrollToElement(findTestObject('HIGO_Blogs/bt_Business Tip'), 0)

WebUI.click(findTestObject('HIGO_Blogs/bt_Business Tip'))

WebUI.verifyElementVisible(findTestObject('HIGO_Blogs/div_Business Tip'))
