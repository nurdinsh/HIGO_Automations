...
WebUI.scrollToElement(findTestObject('HIGO_Blogs/bt_Lifestyle'), 0)

WebUI.click(findTestObject('HIGO_Blogs/bt_Lifestyle'))

WebUI.verifyElementVisible(findTestObject('HIGO_Blogs/div_Lifestyle'))
