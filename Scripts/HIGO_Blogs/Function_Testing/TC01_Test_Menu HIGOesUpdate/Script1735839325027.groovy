...
WebUI.scrollToElement(findTestObject('HIGO_Blogs/bt_HIGOes Update'), 0)

WebUI.click(findTestObject('HIGO_Blogs/bt_HIGOes Update'))

WebUI.verifyElementVisible(findTestObject('HIGO_Blogs/div_HIGOes Update'))
